...
| 2026-W31 (Jul 29) | 0 | No new Library captures since Jul 27. The three-item corpus remains centered on **politeness as containment**: gentle gestures, socially mandated accommodation, and “safe” spaces that exclude or trap. Thresholds (doors/rooms), delayed recognition, and contrast-driven imagery are the recurring directing tools. | Make the existing "polite trap" exercise the next capture: use *Misguided Care* for the blocking, *Date* for the escalation/payoff, and *Angel In Hell* for the false-sanctuary visual language. Capture its strongest shot or line afterward in Visual-Inspiration or Dialogue-Drips. |

---

*Library created 2026-06-09. Last cron update: 2026-07-29.*
