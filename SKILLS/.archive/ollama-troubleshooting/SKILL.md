...
- `references/hermes-model-recommendations.md` — Bookmark to YouTube video covering which models are best for which Hermes tasks (URL only, extract when Ollama generate works)
