...
> **See Also:** `layer-memory/` (Hot/Warm/Cold memory architecture), `alfred/` (CEO counterpart), `arek-and-co/life-os.md` (Emily/Alfred division of labor), `references/operator-emily-alfred-routing.md` (routing trigger)
