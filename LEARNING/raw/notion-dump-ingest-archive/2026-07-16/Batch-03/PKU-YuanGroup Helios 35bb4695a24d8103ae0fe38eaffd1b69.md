...
Description: Real-time long video generation — 14B model at 19.5 FPS on a single H100, supporting T2V/I2V/V2V up to 60 seconds without standard acceleration tricks.
...
- Long-form continuous shots (full scene, no cuts)
...
- H100 for real-time; consumer GPU viable with group offloading
...
Achieves speed without standard tricks by rethinking training/inference throughput at architecture level. 33-frame chunk size auto-rounds non-multiples up. Community YouTube tutorial covers 4K + consumer PC setup.