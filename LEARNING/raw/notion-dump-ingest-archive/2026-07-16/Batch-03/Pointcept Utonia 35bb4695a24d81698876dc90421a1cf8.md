...
- Standalone inference or package-mode integration
...
- CUDA 12.4, PyTorch 2.5.0 via conda (environment.yml), FlashAttention required
- open3d, gradio, scipy, trimesh for demos
...
Encoder-only (no decoder). Features extracted hierarchically and mapped back via pooling inverse. Scale parameter controls granularity. Modified from Meta's Sonata and Pointcept's Concerto.