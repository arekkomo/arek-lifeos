...
- Multi-GPU required (>= 8 x 40GB or 4 x 80GB)
- Base: tencent/HunyuanImage-3.0-Instruct
...
Fully feedforward — no test-time optimization. Competitive with closed-source Nano Banana 2/Pro. Distilled checkpoint planned but not released as of 2026-03. MoE impl can use eager mode.